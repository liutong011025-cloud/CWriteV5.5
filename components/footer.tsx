        ...
        <div className="mx-auto grid max-w-[1600px] gap-5 px-5 py-6 sm:px-8 lg:grid-cols-[minmax(300px,0.72fr)_1.4fr] lg:items-center lg:px-12">
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 lg:justify-start">
            <Image
              ...
              width={280}
              height={92}
              className="h-auto w-[230px] object-contain drop-shadow-[2px_3px_0_rgba(0,0,0,0.28)] sm:w-[270px]"
              priority={false}
            />
            ...
            <Image
              ...
              width={210}
              height={60}
              className="h-auto w-[168px] object-contain drop-shadow-[2px_3px_0_rgba(0,0,0,0.22)] sm:w-[195px]"
              priority={false}
            />
          </div>
          ...
          <div className="border-4 border-[#3d260f] bg-[#f7dfad] p-4 text-center text-[#3a240f] shadow-[inset_4px_4px_0_rgba(255,255,255,0.45),inset_-4px_-4px_0_rgba(92,55,18,0.18),4px_4px_0_rgba(0,0,0,0.22)] lg:text-left">
            ...
            <div className="mt-4 flex flex-col gap-2 border-t-2 border-[#8b5a24]/35 pt-3 text-xs font-bold leading-5 text-[#5a3612] sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
