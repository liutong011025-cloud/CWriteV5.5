...
export default function StageHeader({ stage, title, onBack, character, className }: StageHeaderProps) {
  return (
    <div className={`flex items-center justify-between mb-8 mt-4 ${className || ""}`}>
      <div className="flex items-center gap-4">
        ...
        <Button
          ...
          variant="ghost"
          size="icon"
          className="rounded-full p-0 hover:bg-transparent focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-primary/60 w-24 h-24 lg:w-28 lg:h-28"
        >
          <Image
            src="/back.png"
            alt="Back"
