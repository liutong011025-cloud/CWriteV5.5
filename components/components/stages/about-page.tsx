...
export default function AboutPage({
  ...
  // 首次進入時根據 initialSection 滾動到對應區塊
  useEffect(() => {
    const scrollTarget =
  ...
  return (
    <div className="about-new-theme min-h-screen bg-background" style={{ paddingTop: "88px", paddingBottom: "0" }}>
      ...
      <section ref={visionRef} className={`${showVisionPage ? "" : "hidden"} py-12 px-4 bg-background relative overflow-hidden`}>
        <div className="absolute inset-0 -z-10">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          {/* For Writers / For Research 改為左右並列，移除 50M+ / 5K+ 數字卡 */}
      ...
      <section ref={teamRef} className={`${showResearchPage ? "" : "hidden"} ${showVisionPage ? "pt-12" : "pt-4"} pb-16 md:pb-24 px-4 relative overflow-hidden`}>
