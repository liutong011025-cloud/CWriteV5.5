      ...
      <div className="relative z-10 min-h-screen px-6 lg:px-12 py-12 lg:py-20" style={{ paddingTop: "128px", paddingBottom: "120px" }}>
        {onBack && (
          <button
            type="button"
            onClick={onBack}
            className="absolute left-6 top-10 z-20 rounded-full p-0 hover:scale-110 transition-transform duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary/60"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {onRetest && (
                        <button
                          type="button"
                          className="px-3 py-1 rounded-full text-xs font-bold text-white bg-gradient-to-r from-fuchsia-500 via-purple-500 to-blue-500 hover:scale-105 transition-transform duration-200 shadow-lg"
                          onClick={onRetest}
                        >
                          Retest
                        </button>
