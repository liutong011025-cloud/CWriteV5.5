  ...
  return (
    <div className="fixed bottom-6 left-6 z-[200] flex items-end gap-3 pointer-events-none">
      ...
      {showBubble && displayMessage && (
        <div
          className="pointer-events-auto max-w-md rounded-2xl border border-purple-200 bg-gradient-to-br from-purple-50 via-pink-50 to-amber-50 px-5 py-4 shadow-xl"
