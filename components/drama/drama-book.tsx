...
function stripCharactersRoleDescriptions(script: string) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Any other line ends the characters block.
    inCharacters = false;
  }
...
export function DramaBook({ onBack, onBackToMap, onSave }: DramaBookProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <BackButton onClick={onBack} variant="indigo" />
      <header className="glass sticky top-0 z-30 border-b border-border/50">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 pl-28 lg:pl-32">
          <div className="flex items-center gap-2">
                ...
                <div className="flex min-h-[440px] flex-col items-center justify-center p-8 md:min-h-[520px]">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    <div className="mb-5 flex items-center gap-3">
                      <Sparkles className="h-7 w-7 animate-sparkle text-secondary" />
