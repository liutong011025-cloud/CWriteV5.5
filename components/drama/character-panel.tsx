...
export function CharacterPanel() {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-xl border-2 border-purple-300 bg-gradient-to-br from-white via-purple-50 to-pink-50 p-3 shadow-lg">
      <h3 className="font-hand text-sm font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
        👤 Characters
      </h3>
