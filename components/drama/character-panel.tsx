...
function PresetCharacterCell({
  ...
  return (
    <button
      ...
      onClick={onPick}
      className={cn(
        "group relative flex aspect-square w-full flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-[#4a2a15] bg-[#7a4a1f] px-0 py-0 shadow-[inset_0_2px_0_rgba(255,255,255,0.18)] transition-all",
    ...
    >
      ...
      <span className="mt-0.5 w-full truncate px-1 text-center font-hand text-[10px] font-bold leading-tight text-[#f7e6d0]">
        {preset.species}
      </span>
    </button>
  );
  ...
  return (
    <div className="styled-scrollbar sticky top-28 flex max-h-[calc(100vh-8rem)] flex-col gap-4 overflow-y-auto rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <Dialog open={toyBoxOpen} onOpenChange={handleToyBoxOpenChange}>
        <DialogContent
          showCloseButton
          className="max-h-[90vh] overflow-y-auto sm:max-w-[min(64rem,calc(100%-2rem))] bg-gradient-to-br from-amber-50 via-white to-sky-50"
        >
          {toyBoxStep === "pick" ? (
            <>
              <DialogHeader>
              ...
              <div
                ...
                style={{
                  backgroundImage: [
                    ...
                    "repeating-linear-gradient(90deg, rgba(255,255,255,0.10) 0, rgba(255,255,255,0.10) 2px, transparent 2px, transparent 26px)",
                    "repeating-linear-gradient(0deg, rgba(0,0,0,0.14) 0, rgba(0,0,0,0.14) 2px, transparent 2px, transparent 26px)",
                  ].join(","),
