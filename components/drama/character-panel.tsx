...
function PresetCharacterCell({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute left-1/2 top-1 z-20 w-[92%] -translate-x-1/2 opacity-0 translate-y-1 transition-all duration-150 group-hover:opacity-100 group-hover:translate-y-0">
        <div className="rounded-xl border border-white/50 bg-white/85 px-2 py-1 text-center font-hand text-[10px] font-bold leading-tight text-[#2b1b12] shadow-[0_12px_22px_rgba(0,0,0,0.25)]">
          {greeting}
        </div>
      </div>
