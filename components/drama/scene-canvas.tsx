...
export function SceneCanvas() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Background prompt */}
      <div className="flex items-center gap-2 px-1 bg-gradient-to-r from-indigo-100/50 to-purple-100/50 rounded-xl p-3 border-2 border-purple-200">
        ...
        <input
          ...
          className="flex-1 rounded-lg border-2 border-purple-300 bg-white px-3 py-2 font-hand text-sm text-foreground shadow-sm transition-all placeholder:text-purple-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200"
        />
        <Button
          onClick={handleGenerateBg}
          disabled={scene.isGeneratingBg || !scene.backgroundPrompt.trim()}
          size="sm"
          className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 rounded-lg font-hand transition-transform hover:scale-105 shadow-lg border-2 border-white/30"
        >
      ...
      <div className="px-1">
        <textarea
          ...
          rows={2}
          className="w-full resize-none rounded-lg border-2 border-purple-300 bg-gradient-to-br from-white to-purple-50 px-3 py-2 font-hand text-sm text-foreground shadow-sm transition-all placeholder:text-purple-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-200"
        />
      </div>
    </div>
  );
