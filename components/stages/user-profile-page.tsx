                        ...
                        .map((record, i) => (
                          ...
                          >
                            ...
                            <p className="text-sm text-amber-900 italic border-l-2 border-amber-300/70 pl-3 mt-1">
                              「{record.triggerSentence || record.excerpt}」
                            </p>
                            ...
                            <p className="text-sm text-amber-800/95 leading-relaxed mt-1">
                              {record.reason ||
                                `This sentence supports ${TREE_DIMENSION_NAMES[selectedTreeId] ?? "this value"} because it shows a clear positive attitude or action in the writing.`}
                            </p>
                          </div>
                        ))
                    )}
