    ...
    void (async () => {
      try {
        ...
        if (res.ok) {
          ...
          const mapImageUrl = json?.state?.mapImageUrl
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (!res.ok) return
        const json = await res.json()
        const latest = json?.state?.mapImageUrl
    ...
    return (
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-6">
          ...
          >
            <img src="/back.png" alt="Back" className="h-16 w-16 object-contain lg:h-20 lg:w-20" />
          </button>
              ...
              >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={dim.key} className="rounded-xl border border-purple-200 bg-purple-50/40 p-3">
                        ...
                        <div className="flex items-center gap-1">
                          {[1, 2, 3].map((star) => (
                            <button
                              key={star}
                              type="button"
                              className={`text-lg leading-none transition ${starRatings[dim.key as keyof typeof starRatings] >= star ? "text-yellow-500" : "text-gray-300 hover:text-yellow-400"}`}
                              onClick={() =>
                                setStarRatings((prev) => ({
                                  ...prev,
                      ...
                      <textarea
                        ...
                        className="min-h-[70px] w-full rounded-lg border border-purple-200 bg-white/80 p-2 text-xs focus:outline-none"
                      />
                    </div>
                  ))}
                  <div className="rounded-xl border border-purple-200 bg-purple-50/30 p-3">
                    ...
                    <textarea
                      ...
                      className="min-h-[80px] w-full rounded-lg border border-purple-200 bg-white/80 p-2 text-xs focus:outline-none"
                    />
                  </div>
                </div>
