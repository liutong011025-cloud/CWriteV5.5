...
export default function LetterEdit({
  ...
  const handleSave = async () => {
    trackProcess("LETTER_044", {}, { stage: "letterEdit" })
    setIsSaving(true)
    try {
      // 保存到数据库
    ...
    <PixelPage style={{ paddingTop: "120px", paddingBottom: "120px" }} className="py-8 px-6">
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          ...
          <p className="pixel-text" style={{ color: "#5a4a2a" }}>Make changes to your letter. AI will provide helpful suggestions!</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="pixel-panel p-6 shadow-lg">
              <h3 className="text-xl font-bold mb-4 pixel-text" style={{ color: "#6b5210" }}>Letter Info</h3>
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-semibold mb-1 pixel-text" style={{ color: "#6b5210" }}>Recipient</p>
                  <p className="text-lg font-bold pixel-text" style={{ color: "#5a4a2a" }}>{recipient}</p>
                </div>
                <div>
                  <p className="text-sm font-semibold mb-1 pixel-text" style={{ color: "#6b5210" }}>Occasion</p>
                  <p className="text-lg font-bold pixel-text" style={{ color: "#3a8aa3" }}>{occasion}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-xl p-6 border-2 border-pink-200 shadow-xl">
              ...
              <Textarea
                ...
                onChange={(e) => {
                  ...
                  trackProcessInput("LETTER_041", e.target.value, { field: "letter_edit" }, { stage: "letterEdit" })
                }}
