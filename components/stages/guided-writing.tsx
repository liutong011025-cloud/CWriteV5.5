                  ...
                  >
                    <div className="relative">
                      ...
                      {(isLoadingEvaluation || shortEvaluation) && (
                        <div className="absolute left-1/2 top-full mt-2 w-[380px] -translate-x-1/2 rounded-2xl border border-purple-300 bg-white/95 px-4 py-3 text-sm text-purple-800 shadow-xl">
