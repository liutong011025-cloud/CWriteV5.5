    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-purple-50 via-pink-50 via-orange-50 to-yellow-50">
      ...
      <div className="relative z-10 min-h-screen px-6 lg:px-12 pb-12 lg:pb-20" style={{ paddingTop: '128px', paddingBottom: '120px' }}>
        ...
        <div className="text-center mb-12 lg:mb-16 mt-16 lg:mt-24 animate-fade-in-up" style={{ animationDelay: '0s' }}>
          <div className="mb-4" style={{ height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ 
          ...
          <div style={{ height: '180px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div style={{ 
              ...
              <TextPressure
                ...
                scale={false}
                textColor="currentColor"
                className="text-8xl md:text-9xl lg:text-[12rem] font-black italic"
                minFontSize={64}
              />
            </div>
          </div>
        ...
        <div className="text-center mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <ScrollReveal
            containerClassName=""
            textClassName="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2"
          >
            {t.futureTitle}
          </ScrollReveal>
          <ScrollReveal
            containerClassName=""
            textClassName="text-xl md:text-2xl text-gray-600 font-medium"
          >
            {t.inAIEra}
          </ScrollReveal>
        </div>
        ...
        <div className="text-center mb-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <ScrollReveal
            containerClassName=""
            textClassName="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent"
          >
