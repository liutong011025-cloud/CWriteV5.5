      ...
      <div className="relative z-10 min-h-screen px-6 lg:px-12 pb-12 lg:pb-20" style={{ paddingTop: '128px', paddingBottom: '120px' }}>
        ...
        {activeType && (
          <div className="max-w-5xl mx-auto mb-20 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            {/* 单层容器：本身就是边框区域，ShapeBlur 贴着容器边缘绘制 */}
            <div
              ref={introContainerRef}
              className="relative overflow-hidden rounded-3xl bg-white/96 backdrop-blur-xl shadow-[0_25px_60px_rgba(148,27,153,0.25)] px-6 py-8 md:px-10 md:py-10"
            >
              {/* ShapeBlur 边框特效：直接贴合整个容器 */}
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="space-y-3 rounded-2xl bg-white/90 border border-purple-100 shadow-inner px-5 py-4">
