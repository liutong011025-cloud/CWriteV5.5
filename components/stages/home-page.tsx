    ...
    <div className="min-h-screen relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 min-h-screen px-6 lg:px-12 pb-12 lg:pb-20" style={{ paddingTop: '128px', paddingBottom: '120px' }}>
        ...
        <div className="text-center mb-12 mt-20 animate-fade-in" style={{ animationDelay: '0.7s' }}>
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-4">Start with a Plan。Your Journey Ticket</p>
          <p className="text-base md:text-lg text-gray-500 mb-8">Drag a journey type onto the ticket, then choose your difficulty.</p>
          <Button
            onClick={() => {
              // 跳转到制定学习计划界面
              onStartPlan?.()
