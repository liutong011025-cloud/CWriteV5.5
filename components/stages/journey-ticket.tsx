    ...
    <div className="min-h-screen relative overflow-hidden pixel-theme">
      ...
      <div className="relative z-10 min-h-screen px-6 lg:px-12 py-12 lg:py-20 pl-16 lg:pl-20" style={{ paddingTop: "128px", paddingBottom: "120px" }}>
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-4 pixel-title" style={{
            color: "#8b6914",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 mb-10">
          ...
          <div className="flex flex-col justify-center lg:justify-start">
            <p className="text-sm mb-4 text-center lg:text-left max-w-[280px] pixel-text" style={{ color: "#5a4a2a" }}>
              ...
              {journeyOptions.map((option, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`relative p-4 cursor-pointer transition-all duration-200 pixel-btn bg-gradient-to-b ${option.pixelBg}`}
                    style={{
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-3xl" style={{ imageRendering: "pixelated" }}>{option.icon}</span>
          ...
          <div className="max-w-5xl mx-auto">
            <div className={`relative pixel-panel p-8 ${isDeparting ? "animate-ticket-tear" : ""}`}>
              {/* Stamp effect */}
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-2xl font-bold" style={{ color: "#8b6914" }}>Level {difficulty}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {/* Pixel airplane */}
              <div className={`absolute -top-6 right-10 text-4xl ${isDeparting ? "plane-flyaway" : ""}`} style={{ imageRendering: "pixelated" }}>
                ✈️
              </div>
