        ...
        <div className="text-center mt-10 space-y-3">
          {mapImageStatus === "loading" && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-orange-600 font-semibold">The Start button is disabled because the map is still being generated. Please wait for the map to be ready.</p>
            </div>
          )}
          ...
          <Button
            onClick={handleStart}
            size="lg"
            disabled={!selectedType || !difficulty || mapImageStatus === "loading"}
