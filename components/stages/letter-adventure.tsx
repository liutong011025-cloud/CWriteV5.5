...
export default function LetterAdventure({ onStart, onBack, userId, noAi = false }: LetterAdventureProps) {
  ...
  const handleStart = async () => {
    ...
    setIsLoading(true)
    trackProcess("LETTER_005", { recipient: recipient.trim(), occasion: occasion.trim() }, { stage: "letterAdventure" })
    try {
      if (noAi) {
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  trackProcessInput("LETTER_002", e.target.value, { field: "recipient" }, { stage: "letterAdventure" })
                }}
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  trackProcessInput("LETTER_003", e.target.value, { field: "occasion" }, { stage: "letterAdventure" })
                }}
