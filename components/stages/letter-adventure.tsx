  ...
  return (
    <PixelPage style={{ paddingTop: "120px", paddingBottom: "120px" }} className="py-6 px-4">
      <div className="max-w-4xl mx-auto relative">
        ...
        {/* 提示卡片 */}
        <div className="mt-8 pixel-card p-6 shadow-lg" style={{ background: "#f5e6c8" }}>
          <div className="flex items-start gap-4">
            <div className="text-4xl">💡</div>
            <div>
              <h3 className="text-lg font-bold mb-2 pixel-text" style={{ color: "#6b5210" }}>Writing Tips for Kids!</h3>
              <ul className="text-sm space-y-1 pixel-text" style={{ color: "#5a4a2a" }}>
