...
import { startProcessSession, trackProcess, trackProcessInput } from "@/lib/process-logger"
...
export default function CharacterCreation({ language, onCharacterCreate, onBack, userId, level = 1 }: CharacterCreationProps) {
  ...
  const lastStrokeLogRef = useRef(0)
  const sketchStartedRef = useRef(false)
  ...
  const clearSketch = () => {
    fillCanvasBase()
    setHasSketchStroke(false)
    sketchStartedRef.current = false
    trackProcess("STORY_012", {}, { stage: "character" })
  }
  ...
  const draw = (event: React.PointerEvent<HTMLCanvasElement>) => {
    ...
    if (drawMode === "eraser") {
      trackProcess("STORY_011", {}, { stage: "character" })
    } else if (!sketchStartedRef.current) {
      sketchStartedRef.current = true
      trackProcess("STORY_008", { tool: drawMode }, { stage: "character" })
    } else {
      const now = Date.now()
      if (now - lastStrokeLogRef.current > 1500) {
        lastStrokeLogRef.current = now
        trackProcess("STORY_009", { tool: drawMode }, { stage: "character" })
      }
    }
  }
  ...
  const toggleTrait = (traitName: string) => {
    ...
    trackProcess("STORY_005", { trait: traitName }, { stage: "character" })
  }
  ...
  const handleGenerateImage = async () => {
    ...
    trackProcess("STORY_014", { has_sketch: hasSketchStroke, species: finalSpecies }, { stage: "character" })
  ...
  const handleCreate = () => {
    ...
    trackProcess("STORY_015", { from_stage: "character", to_stage: "storyCollab" }, { stage: "character" })
    onCharacterCreate({
      name: name.trim(),
      age: safeAge,
      traits: selectedTraits,
    ...
    <div className="min-h-screen relative overflow-hidden pixel-theme" style={{ paddingTop: "120px", paddingBottom: "120px" }}>
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-6 py-8">
        <StageHeader
          ...
          onBack={() => {
            trackProcess("STORY_040", { from_stage: "character" }, { stage: "character" })
            onBack()
          }}
          language={language}
        />
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-2.5 md:gap-3">
                {SPECIES.map((spec) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        setSpecies(spec.name)
                        trackProcess("STORY_001", { species: spec.name }, { stage: "character" })
                      }}
                      className={`flex min-h-[76px] md:min-h-[82px] flex-col items-center justify-center gap-1 px-3 py-2.5 text-sm md:text-base font-bold transition pixel-btn ${
                ...
                <button
                  ...
                  onClick={() => {
                    setSpecies("Custom")
                    trackProcess("STORY_001", { species: "Custom" }, { stage: "character" })
                  }}
                  className={`flex min-h-[76px] md:min-h-[82px] flex-col items-center justify-center gap-1 px-3 py-2.5 text-sm md:text-base font-bold transition pixel-btn ${
                    species === "Custom"
              ...
              {species === "Custom" && (
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    trackProcessInput("STORY_002", e.target.value, { field: "custom_species" }, { stage: "character" })
                  }}
              ...
              <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setDrawMode("eraser")
                      trackProcess("STORY_010", {}, { stage: "character" })
                    }}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      trackProcess("STORY_013", { tool: "color" }, { stage: "character" })
                    }}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    trackProcessInput("STORY_003", e.target.value, { field: "name" }, { stage: "character" })
                  }}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    trackProcessInput("STORY_004", e.target.value, { field: "age" }, { stage: "character" })
                  }}
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          trackProcess("STORY_006", { trait: trait.name }, { stage: "character" })
                        }}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => {
                        ...
                        trackProcessInput("STORY_007", e.target.value, { field: "background" }, { stage: "character" })
                      }}
                      rows={3}
