      ...
      <section className="py-12 px-4 bg-background relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div
              className="h-96 rounded-[2rem] border-4 border-foreground bg-gradient-to-br from-primary/10 to-secondary/10 shadow-brutal hover:shadow-xl transition-all duration-500 flex items-center justify-center group relative overflow-hidden cursor-pointer"
              onMouseEnter={() => setHoveredStat(0)}
              onMouseLeave={() => setHoveredStat(null)}
            >
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent group-hover:translate-x-full transition-transform duration-1000" />
              <div className="text-center relative z-10">
                <div className={`text-6xl md:text-8xl font-black bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent transition-transform duration-500 ${hoveredStat === 0 ? "scale-125" : ""}`}>50M+</div>
                <p className="text-muted-foreground font-bold mt-4 text-lg">{t.writersStat}</p>
              </div>
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-accent rounded-[1.5rem] rotate-12 group-hover:rotate-45 transition-transform duration-500 shadow-brutal border-4 border-foreground" />
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-chart-2 rounded-[1rem] -rotate-12 group-hover:-rotate-45 transition-transform duration-500 shadow-brutal border-4 border-foreground" />
            </div>
          </div>
          <div className="w-24 h-2 bg-gradient-to-r from-primary via-secondary to-accent mx-auto rounded-full shadow-brutal my-12" />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div
              className="h-96 rounded-[2rem] border-4 border-foreground bg-gradient-to-br from-secondary/10 to-accent/10 shadow-brutal hover:shadow-xl transition-all duration-500 flex items-center justify-center group relative overflow-hidden cursor-pointer order-last md:order-first"
              onMouseEnter={() => setHoveredStat(1)}
              onMouseLeave={() => setHoveredStat(null)}
            >
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent group-hover:translate-x-full transition-transform duration-1000" />
              <div className="text-center relative z-10">
                <div className={`text-6xl md:text-8xl font-black bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent transition-transform duration-500 ${hoveredStat === 1 ? "scale-125" : ""}`}>5K+</div>
                <p className="text-muted-foreground font-bold mt-4 text-lg">{t.researchStat}</p>
              </div>
              <div className="absolute -top-4 -left-4 w-16 h-16 bg-primary rounded-[1.5rem] -rotate-12 group-hover:-rotate-45 transition-transform duration-500 shadow-brutal border-4 border-foreground" />
              <div className="absolute -bottom-4 -right-4 w-12 h-12 bg-chart-3 rounded-[1rem] rotate-12 group-hover:rotate-45 transition-transform duration-500 shadow-brutal border-4 border-foreground" />
            </div>
            <div className="p-8 rounded-[2rem] border-4 border-foreground bg-card shadow-brutal hover:shadow-xl transition-all duration-500 group relative overflow-hidden">
