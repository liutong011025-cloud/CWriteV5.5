    ...
    <div className="relative">
      {onBack && (
        <div className="absolute top-4 left-4 z-50">
          <button
            onClick={onBack}
            className="rounded-lg bg-white/95 backdrop-blur-sm border-2 border-purple-300 px-5 py-2.5 font-hand text-base font-bold text-purple-700 hover:bg-purple-50 transition-colors shadow-lg"
          >
            ← Back
          </button>
        </div>
