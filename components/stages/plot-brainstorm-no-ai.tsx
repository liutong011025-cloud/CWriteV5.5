...
export default function PlotBrainstormNoAi({ language, character, onPlotCreate, onBack, userId }: PlotBrainstormNoAiProps) {
  ...
  return (
    <div className="min-h-screen py-8 px-6 bg-gradient-to-br from-blue-100 via-cyan-50 via-purple-50 to-pink-50 relative" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
