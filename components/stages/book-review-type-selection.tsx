          ...
          <div className="grid gap-8 md:grid-cols-3">
            {reviewTypes.map(type => {
              ...
              return (
                <div
                  key={type.id}
                  className={`relative rounded-3xl p-6 shadow-xl bg-white/90 border-2 transition-all duration-300 cursor-pointer ${
                    isExpanded
                      ? "ring-4 ring-blue-300 border-blue-400"
                      : isRecommended
                ...
                >
                  ...
                  {isExpanded && selectedTypeData && selectedTypeData.id === type.id && (
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600 mb-3">{selectedTypeData.description}</p>
                      ...
                      <div className="flex gap-3">
                        <Button
                          ...
                          size="sm"
                          className="flex-1 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 text-white border-0 font-bold"
                        >
                          {t.chooseButton}
                        </Button>
                        <Button
