...
export default function BookReviewTypeSelection({ language = "en", bookTitle, onSelectType, onBack }: BookReviewTypeSelectionProps) {
  ...
  const handleCardClick = (type: ReviewTypeId) => {
    ...
    trackProcess("BOOK_011", { review_type: type }, { stage: "bookReviewTypeSelection" })
  }

  const handleConfirm = () => {
    if (selectedType) {
      trackProcess("BOOK_012", { review_type: selectedType, book_title: bookTitle }, { stage: "bookReviewTypeSelection" })
