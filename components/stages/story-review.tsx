...
export default function StoryReview({ language, storyState, onReset, onEdit, onBack, userId, workId }: StoryReviewProps) {
  ...
  useEffect(() => {
    ...
    trackProcess("STORY_030", { story_version: storyState.story?.length ?? 0 }, { stage: "review" })
  ...
  const handleUploadToLibrary = async () => {
    ...
    trackProcess("STORY_038", { work_id: workId ?? null }, { stage: "review" })
    setIsUploading(true)
    try {
  ...
  const handleApplyCorrection = (errorIndex: number) => {
    ...
    trackProcess(
      "STORY_032",
      { error_id: errorIndex, original_text: error.original, corrected_text: error.corrected },
      { stage: "review" },
    )
        ...
        if (part.isError && part.errorIndex !== undefined) {
          ...
          result.push(
            <span
              ...
              onClick={() => {
                setClickedErrorIndex(clickedErrorIndex === part.errorIndex ? null : part.errorIndex!)
                trackProcess("STORY_031", { error_id: part.errorIndex }, { stage: "review" })
              }}
            >
              <span
  ...
  const handleDownload = () => {
    ...
    trackProcess("STORY_041", {}, { stage: "review" })
    ...
    <div className="min-h-screen py-8 px-6 relative overflow-hidden pixel-theme" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
          ...
          >
            <div className="text-center">
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Button
                  onClick={() => {
                    trackProcess("STORY_037", {}, { stage: "review" })
                    setShowUploadDialog(false)
                  }}
                  disabled={isUploading}
                  variant="outline"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <StageHeader
          ...
          title={t.reviewTitle}
          onBack={() => {
            trackProcess("STORY_040", { from_stage: "review" }, { stage: "review" })
            onBack()
          }}
          language={language}
        />
        ...
        <div className="grid lg:grid-cols-12 gap-6 mt-8 min-w-0">
          ...
          <div className="lg:col-span-8 space-y-6 min-w-0">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Button 
                onClick={() => {
                  trackProcess("STORY_033", {}, { stage: "review" })
                  onEdit("storyEdit")
                }} 
                size="lg"
