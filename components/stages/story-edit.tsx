...
export default function StoryEdit({
  ...
  useEffect(() => {
    ...
    if (editedStory !== originalStory && editedStory !== lastModifiedRef.current) {
      suggestionTimeoutRef.current = setTimeout(() => {
        trackProcess("STORY_035", {}, { stage: "storyEdit" })
  ...
  const handleSave = async () => {
    setIsSaving(true)
    trackProcess("STORY_036", { text_snapshot: editedStory.slice(0, 8000) }, { stage: "storyEdit" })
    try {
  ...
  return (
    <div className="min-h-screen py-8 px-6 bg-gradient-to-br from-indigo-100 via-purple-50 via-pink-50 to-orange-50 relative" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
      <StageHeader
        ...
        onBack={() => {
          trackProcess("STORY_040", { from_stage: "storyEdit" }, { stage: "storyEdit" })
          onBack()
        }}
        language={language}
      />
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-xl p-6 border-2 border-purple-200 shadow-xl">
              ...
              <Textarea
                ...
                onChange={(e) => {
                  ...
                  trackProcessInput("STORY_034", e.target.value, { field: "story_edit" }, { stage: "storyEdit" })
                }}
              ...
              <div className="mt-4">
                <Button
                  onClick={() => {
                    trackProcess("STORY_039", {}, { stage: "storyEdit" })
