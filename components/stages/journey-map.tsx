    ...
    <div className="min-h-screen relative overflow-hidden pt-24 md:pt-28">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-full h-2 bg-gradient-to-r from-transparent via-yellow-400/60 to-transparent blur-sm"></div>
          <div className="absolute w-full h-1 bg-yellow-300/40"></div>
          <div className="absolute w-full h-0.5 bg-yellow-200/60" style={{ 
            ...
            >
              <div className="relative w-40 h-40 md:w-48 md:h-48 flex items-center justify-center">
                ...
                <button
                  ...
                  title={task.title}
                  className={`relative z-10 w-36 h-36 md:w-44 md:h-44 flex flex-col items-center justify-center gap-2 rounded-2xl shadow-2xl transition-all border-3 ${
                    task.isComplete
