...
import { ArrowLeft, Flag, Wand2 } from "lucide-react"
        ...
        <div className="relative w-full h-[calc(100vh-120px)] flex">
          ...
          {!pinBoxHidden && (
            <div className="absolute right-5 bottom-6 z-20 flex flex-col items-center gap-2">
              <p className="mb-2 max-w-[680px] text-[20px] md:text-2xl leading-tight font-hand font-extrabold text-center drop-shadow-[0_1px_1px_rgba(255,255,255,0.98)] atlas-jitter-sm">
              ...
              {isHoveringBox && (
                <div className="absolute right-full mr-3 bottom-1/2 translate-y-1/2 rounded-xl border border-purple-200 bg-white/95 px-5 py-3 text-lg font-hand text-purple-800 shadow-lg max-w-[620px]">
