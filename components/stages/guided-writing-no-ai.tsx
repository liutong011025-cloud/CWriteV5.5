...
export default function GuidedWritingNoAi({ language, storyState, onStoryWrite, onBack, userId, onDraftChange }: GuidedWritingNoAiProps) {
  ...
  return (
    <div className="min-h-screen py-8 px-6 bg-gradient-to-br from-green-100 via-emerald-50 via-blue-50 via-purple-50 to-pink-50 relative" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
