...
export default function LetterPuzzle({
  ...
  const handleDropToZone = (e: React.DragEvent, zoneIndex: number) => {
    ...
    if (draggedItem) {
      ...
      setDraggedItem(null)
      trackProcess("LETTER_024", { source_index: draggedItem.originalIndex, target_zone: zoneIndex }, { stage: "letterPuzzle" })
    }
  }
  ...
  const handleReset = () => {
    ...
    trackProcess("LETTER_026", {}, { stage: "letterPuzzle" })
  }
  ...
  const handleComplete = () => {
    if (isCorrectOrder) {
      ...
      trackProcess("LETTER_028", { ordered_sections: reorderedSections.length }, { stage: "letterPuzzle" })
