...
export default function PoetryWriting({ initialPhase, userId, onBack, onBackToMap, onComplete, backLabel, onTopicSelected }: PoetryWritingProps) {
  ...
  const content = (() => {
    switch (phase) {
      ...
      case "review":
        return <PoetryReview onBack={onBack} onComplete={onComplete} onBackToMap={onBackToMap} userId={userId} />;
      default:
        return <FormChooser onBack={onBack} backLabel={backLabel} />;
    }
  })();
