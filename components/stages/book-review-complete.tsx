...
export default function BookReviewComplete({
  ...
  useEffect(() => {
    if (review) {
      ...
      setGrammarErrors([])
      trackProcess("BOOK_028", { book_title: bookTitle }, { stage: "bookReviewComplete" })
  ...
  const handleCopy = async () => {
    trackProcess("BOOK_032", {}, { stage: "bookReviewComplete" })
    try {
  ...
  const handleSave = async () => {
    trackProcess("BOOK_033", {}, { stage: "bookReviewComplete" })
    try {
      // 保存到后端
  ...
  return (
    <PixelPage style={{ paddingTop: "120px", paddingBottom: "120px" }} className="py-12 px-6">
      <div className="max-w-6xl mx-auto relative">
        {/* 标题 */}
        <div className="text-center mb-12">
          <h1 className="text-6xl md:text-7xl font-black mb-6 pixel-title" style={{ color: "#6b5210", textShadow: "3px 3px 0 rgba(0,0,0,0.2)" }}>
            🎉 Your Review is Complete! 🎉
          </h1>
          <p className="text-2xl mb-4 pixel-text" style={{ color: "#5a4a2a" }}>
          ...
          {!isNoAi && (
            <div className="lg:col-span-4">
              <div className="p-8 sticky top-8">
                ...
                {bookCoverUrl ? (
                  <div className="relative w-full max-w-[200px] mx-auto aspect-[2/3] overflow-hidden shadow-xl" style={{ border: "4px solid #8b6914" }}>
                    <Image
                      src={bookCoverUrl}
                  ...
                  <div className="relative w-full aspect-[2/3] flex items-center justify-center shadow-xl" style={{ background: "#d9c9a6", border: "4px solid #8b6914" }}>
                    <p className="pixel-text" style={{ color: "#6b5210" }}>Cover generating...</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white via-purple-50 to-pink-50 rounded-3xl p-10 border-4 border-purple-300 shadow-2xl backdrop-blur-sm relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  ...
                  <Button
                    onClick={() => {
                      trackProcess("BOOK_035", {}, { stage: "bookReviewComplete" })
                      if (onEdit) {
                        onEdit()
                      } else {
                        onBack()
