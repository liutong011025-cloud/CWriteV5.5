...
import { BookOpen, Sparkles, Star, ArrowLeft } from "lucide-react";
...
export function FormChooser({ onBack }: FormChooserProps) {
    ...
    <div className="relative flex min-h-screen flex-col items-center overflow-hidden bg-background px-4 py-8">
      ...
      <div className="relative z-10 mb-6 w-full max-w-4xl">
        {onBack ? (
          ...
          <Button variant="ghost" size="sm" className="gap-1.5 rounded-xl font-hand text-sm text-muted-foreground bg-transparent" asChild>
            <Link href="/">
              <ArrowLeft className="h-3.5 w-3.5" />
              Back to Home
            </Link>
