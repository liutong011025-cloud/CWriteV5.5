...
export function BackButton({
  ...
  const baseClass = `rounded-full border-2 p-0 w-14 h-14 transition-transform duration-200 hover:scale-110 inline-flex items-center justify-center ${v} ${className}`
  const icon = <ArrowLeft className="w-7 h-7" strokeWidth={2.5} />
  const btn = href ? (
