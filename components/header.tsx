          ...
          >
            {isHomePage && showLogo ? (
              ...
              />
               ...
               // Gallery 页面显示白色文字
               <span className="font-bold text-xl text-white hover:text-yellow-200 transition-colors cursor-pointer">
                 CWrite
               </span>
             ) : (
               // 非首页显示文字，可点击跳转到About
               <span className={`font-bold text-xl transition-colors cursor-pointer ${
                 showBackground 
