      ...
      {stage === "planTest" && user && (
        <PlanTest
          ...
          onComplete={async (result) => {
            ...
            const prompt = `A detailed fantasy map-style background image inspired by "${favorite}". From an overhead perspective, it presents a beautiful fantasy landscape with a diverse range of elements, full of the characteristics of ${favorite}. The map is scattered with multiple elements, characters, items, and scenes related to ${favorite}. Various landmarks, magical features, and thematic details are added to represent different aspects of ${favorite}. The map should be colorful and visually interesting, containing a large number of elements related to ${favorite}. Various iconic items, scenes, creatures, and visual elements from ${favorite} should be placed throughout the map. In a horizontal band slightly above the visual center of the image (around 30–35% from the top, with a height of approximately 200 to 300 pixels), the objects and details should be significantly reduced to make this area feel more spacious, with more negative space and simpler shapes, while still maintaining visual coherence with the other parts of the map. Just add a few UI task markers here without creating an abrupt division. Do not add any text labels. Just provide a beautiful, detailed fantasy map-style background image full of elements from ${favorite}.`
