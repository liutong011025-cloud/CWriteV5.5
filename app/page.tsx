      ...
      {stage === "planTest" && user && (
        <PlanTest
          ...
          onComplete={async (result) => {
            ...
            const prompt = `A realistic fantasy background image featuring ${favorite}. Photorealistic style, beautiful landscape, natural lighting, detailed elements from the theme, no text labels, just a stunning background image.`
