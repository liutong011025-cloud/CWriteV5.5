...
1. Setting: Extract location/setting. Can be a single word or short phrase.
    2. Conflict: Extract the problem/challenge as a SHORT PHRASE (1-8 words). Example: "save the library" or "find the treasure", NOT just "conflict" or "problem".
    3. Goal: Extract what the character wants as a SHORT PHRASE (1-8 words). Example: "become a wizard" or "help friends", NOT just "goal" or "win".

IMPORTANT:
    - Conflict and Goal MUST be short phrases (1-8 words), not just a label
