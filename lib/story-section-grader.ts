...
import type { PlotState } from "@/lib/story-section-evaluation"
...
export function buildSectionGraderSystemPrompt(params: {
  ...
  return (
    ...
    "5) Completeness — REJECT if draft ends mid-sentence (e.g. trailing comma, or last sentence has no . ! ?), or clearly cut off.\n" +
    ...
    "---META---\n" +
    '{"section_pass":false,"revision_tags":[{"label":"Finish your sentence","rationale":"Your last sentence stops before the idea is finished — add the rest, then end with . ! or ?","color":"amber"}],"checks":{"complete":false,"word_count_ok":true,"plot_coverage":"partial","structure_beat":"weak","coherence":"ok","lexical_ok":true}}\n' +
    "---END---\n" +
    "META rules:\n" +
