...
export function getPlanTestCopy(lang: StoryUiLang) {
  ...
  return {
    ...
    subtitle: zh
      ? "完成这 7 道题，系统会为你选出合适的起始等级。"
      : "Answer these 7 questions so we can choose a good starting level.",
    ...
    ticketUnlocked: zh ? "等级已经选好" : "YOUR LEVEL IS READY",
    ...
    continueToTicket: zh ? "继续" : "Continue",
    cefrNote: zh
