...
export function PoetryEditor() {
  ...
  // For tool panel: append text to the active line (rhyme words, rhetoric examples)
  ...
  // For tool panel: replace the active line entirely (haiku alternatives)
