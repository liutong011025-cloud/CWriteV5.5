...
export function DramaBuilder({ onGenerateDrama }: DramaBuilderProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <header className="glass sticky top-0 z-40 border-b border-border/50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
          <div className="flex items-center gap-3">
            <Link href="/">
              <Button variant="ghost" size="sm" className="gap-1 rounded-xl font-hand text-xs text-muted-foreground bg-transparent">
      ...
      {/* Scene tabs -- z-30 so dropdown floats above the main content below */}
