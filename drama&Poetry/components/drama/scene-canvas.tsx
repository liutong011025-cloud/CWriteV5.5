...
export function SceneCanvas() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Background prompt bar */}
      <GlowCard className="rounded-2xl" innerClassName="rounded-2xl bg-card" borderSize={0.012} circleSize={0.18} circleEdge={0.4}>
      ...
      {/* Scene canvas area -- overflow visible so popover can escape */}
      <div className="relative">
        <div
          ...
          className={cn(
            ...
            scene.backgroundImageUrl
              ? "border-primary/10"
              : "border-dashed border-primary/20 bg-gradient-to-br from-card via-muted/50 to-card"
          )}
          style={
            scene.backgroundImageUrl
              ? {
        ...
        >
          {/* Subtle grid overlay for empty canvas */}
          {!scene.backgroundImageUrl && !scene.isGeneratingBg && (
            <>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-primary/10 text-primary animate-float">
